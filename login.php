...
<div id="content">
    ...
    <div class="row_9"> 
        <div class="container">
                ...
                <div id="getintouch" class="col-lg-12 col-md-12 col-sm-12 address">
                    <h2 id="login" class="padbot3">Login</h2>
                    <form id="contact-form" class="contact-form" action="process_data/login_process.php" method="post">
                      <div class="row">
