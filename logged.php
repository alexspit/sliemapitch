                 ...
                 $res->getReservations($sql);
                    ...
                    /*  include_once 'data_class/db_connection.php';
                       ...
                       // $sql = "SELECT * FROM bookings";
                        $sql = $res->getReservations(NULL, NULL, "newest", "status", "pending");
                 ...
                 <div class="booking">
                                <div class="row">
                                    <div class="col-lg-3 col-md-3 col-sm-2 col-xs-12">
                                        <h3 class="red booking-margin"><?php echo $row['name']; ?></h3> 
                                    </div>
                                    <div class="col-lg-3 col-md-3 col-sm-2 col-xs-6">
                                        <p class="booking-margin"><?php  echo $res->getShortDate().' for '.$period; ?></p> 
                                    </div>
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                                        <p class="booking-margin"><?php echo $row['side']." for ".$row['no_of_people']; ?></p> 
                                    </div>
                                    <div class="col-lg-2 col-md-2 col-sm-3 col-xs-9">
                                        <a href="booking_confirmation.php?id=<?php echo $row['booking_id']; ?>#booking_confirmation" style="width: 100%" data-type="submit" class="
                                            <?php echo $row['status'] ?> 
                                    ...
                                    <div class="col-lg-1 col-md-1 col-sm-2 col-xs-3">
                                        <a href="process_data/delete_booking.php?id=<?php echo $row['booking_id']; ?>" data-type="submit" class="
                                            <?php echo $row['status'] ?> 
                                           btn btn-primary btn1">
                                ...
                                <div class="row">
                                    ...
                                    <div class="hidden-xs col-sm-offset-8 col-sm-4"> 
                                         <p class="booking-details"><?php echo "Booked on ".$row['date_added']; ?></p> 
                                    </div>
